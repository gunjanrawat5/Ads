...
"[project]/apps/web/app/api/feedback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const FeedbackRequestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    feedback: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$schemas$2f$feedback$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ViewerFeedbackSchema"],
    ...
    adCandidate: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$schemas$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AdCandidateSchema"]
});
...
async function POST(request) {
    const parsed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$api$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseJson"])(request, FeedbackRequestSchema);
    if (!parsed.ok) return parsed.response;
    const { sessionId, feedback, videoContext, adCandidate } = parsed.data;
    const analysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$classifier$2f$classifyFeedback$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["classifyFeedback"])(feedback);
    const candidateResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$planner$2f$planSafeResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["planSafeResponse"])({
        analysis,
        videoContext,
        adCandidate
    });
    const candidateMemory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$memory$2f$createMemoryUpdate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createMemoryUpdate"])({
        sessionId,
        feedback,
        analysis
    });
    const safety = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$src$2f$safety$2f$validateSafety$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateSafety"])({
    ...
    const memoryUpdate = {
        ...candidateMemory,
        allowedPreferences: candidateMemory.allowedPreferences.filter((p)=>!blockedIds.has(p.preferenceId)),
        blockedUnsafeLabels: [
    ...
    try {
        ...
        if (!fallbacksEnabled) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$api$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])("PROVIDER_UNAVAILABLE", "Memory provider unavailable.", 503, false);
        }
    }
    const body = {
        analysis,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gozfkd._.js.map